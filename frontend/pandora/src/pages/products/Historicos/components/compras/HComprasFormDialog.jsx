...
const HComprasFormDialog = ({
  ...
  const onSubmit = (e) => {
    ...
    const dataToSubmit = {
      ...
      proveedor: String(formData.proveedor),
    ...
    <Dialog open={modalOpen} onOpenChange={setModalOpen}>
      <DialogContent className="sm:max-w-[750px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Complete los campos para {isEditing ? 'actualizar el' : 'registrar un nuevo'} registro de compra.
          </DialogDescription>
        </DialogHeader>
...
export default HComprasFormDialog;