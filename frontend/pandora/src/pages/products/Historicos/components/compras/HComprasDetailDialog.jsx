    ...
    <Dialog open={detailModalOpen} onOpenChange={setDetailModalOpen}>
      <DialogContent className="sm:max-w-[750px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Información completa del registro de compra
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="p-4 bg-gray-50 rounded-lg border">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-medium">{currentItem.proveedor_detail?.nombre || 'N/A'}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Empresa:</p>
                <p className="font-medium">{currentItem.empresa_detail?.nombre || 'N/A'}</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 bg-purple-50 rounded-lg border border-purple-100">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                <span className="font-medium">{currentItem.producto_detail?.nombre || 'N/A'}</span>
              </p>
              <p>
...
export default HComprasDetailDialog;