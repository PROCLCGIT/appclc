...
import HVentasFilters from "./components/ventas/HVentasFilters";
import HVentasTable from "./components/ventas/HVentasTable";
import HVentasFormDialog from "./components/ventas/HVentasFormDialog";
import HVentasDetailDialog from "./components/ventas/HVentasDetailDialog";

// Importar servicios
import { clientesService, empresasClcService as empresaService, productosDisponiblesService } from '@/services/api';

// Crear un servicio para ventas
class VentasService {
  constructor() {
    this.endpoint = 'products/historial-ventas/';
  }
    ...
    const loadData = async () => {
      ...
      try {
        ...
        if (ventasResponse?.results) {
          ...
          setTotalPages(Math.ceil(ventasResponse.length / itemsPerPage));
        } else {
          setVentas([]);
          setTotalPages(1);
        }
...
export default VentasHistoricaProducto;